...
selections:
    ...
    - selinux_confinement_of_daemons #TODO: needs update
    ...
    # 6 | Page3.4.4.1.2 Ensure loopback traffic is configured (Scored)
    ...
    # 9 | Page5.3.1 Create custom authselect profile (Scored)
