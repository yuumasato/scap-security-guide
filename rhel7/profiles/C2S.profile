...
description: |-
    ...
    (CIS) Red Hat Enterprise Linux 7 Benchmark, v2.2.0 - 12-27-2017.
...
selections:
    ...
    # 1.7.1.3 Ensure remote login warning banner is configured properly (Not Scored) .. 95
    ...
    - set_iptables_default_rule # TODO: enable to rhel6 only
    # OUPUT DROP
    # FORWARD DROP 

    # 3.6.3 Ensure loopback traffic is configured (Scored)
    # 3.6.4 Ensure outbound and established connections are configured (Not Scored) 195
    ...
    # 4.1.3 Ensure auditing for processes that start prior to auditd is enabled (Scored) 207
    ...
    #needs new rule to cover /etc/share/selinux

    # 4.1.8 Ensure login and logout events are collected (Scored)
    - audit_rules_login_events #tallylog is not part of the policy
    ...
    - audit_rules_unsuccessful_file_modification_open_by_handle_at # TODO - not part of policy
    ...
    - audit_rules_file_deletion_events_rmdir ## TODO - not part of policy
    ...
    - sshd_use_approved_ciphers #TODO: this one is extra
